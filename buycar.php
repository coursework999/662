          ...
          <td> 
            <table border=0 cellpadding=0 cellspacing=0 width=630>
              ...
              <tr> 
                ...
                <td bgcolor=#ffffff colspan=3 height=22><b><font class=p14 color=#cc0000>购 
                  物 车</font></b></td>
              </tr>
              <tr bgcolor=#cc0000> 
...
?>
          <tr> 
            ...
            <td width="8%">&nbsp;</td>
            <td width="8%">&nbsp;</td>
            <td colspan="2"> 合计：<b><font color=red>￥<?php echo $price_all_format ?>
              </font></b> </td>
          </tr>
          <tr> 
    ...
    <table align=center border=0 cellpadding=0 cellspacing=0 width=630>
      ...
      <tr> 
        ...
        <td bgcolor=#cc0000 height=22 width="87%"> 
          <div align=left><b><font color=#ffffff>您的收藏夹里面有"<?php echo ($scj=="")?0:count(split("&&",$scj)) ?>"种产品</font></b> </div>
        </td>
        <td bgcolor=#ffc40f class=pad03 height=22 valign=bottom width="87%"> 
          <div align=center><img alt=展开收藏夹 border=0 class=pad03 height=19 
      onClick="JavaScript:tmpstore.style.display=''" 
      src="images/cart_dot03.gif" style="CURSOR: hand" width=19> <img 
      alt=隐藏收藏夹 border=0 class=pad03 height=19 
