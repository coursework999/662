...
<html>
<head>
<title><?php echo $sitename ?> -- 资料修改 </title>
...
echo "<input type=\"button\" value=\"返回首页\" onClick=\"JavaScript:window.location.href='index.php'\" class=\"stbtm\"  name=\"button3\"><br><br>";
}
else
{
...
function check()
{
	if (document.formlogin.u_pass.value)
          ...
          <td height="18"> 
                ...
                <tr align="center"> 
                  <td> 
                    <table width="70%" border="0">
                      ...
                      <tr> 
                        <td align="right" width="22%">所在省份： </td>
                        <td width="78%"> 
			...
			for (i=1;i<=prvcnt;i++)
			{
			  ...
			  document.write ("</option>");
                      ...
                      <tr> 
                        <td align="right" width="22%">所在城市： </td>
                        <td width="78%"> 
...
document.formlogin.sex.value=<?php echo intval($db->f('sex'));?>;
                      ...
                      <tr> 
                        <td align="right" width="22%">证件号码：</td>
                        <td width="78%"> 
