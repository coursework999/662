            ...
            <tr>
                <td height="18" class="p14">
                    <table border=0 cellpadding=0 cellspacing=0 width="100%">
                        <tbody>
                        <tr align="left">
                            <th bgcolor=#ffffff colspan=4 height=22 valign=top><b><font color="#CC0000" class="p14">收
                                货 信 息 </font></b><font color="#CC0000" class="p14"><span class="p9"><font
                                    color="#666666">(请填写以下信息,以保证我们将商品及时准确的送到您手中)</font></span>
                            </font></th>
                        </tr>
                        <tr bgcolor=#cc0000>
                    ...
                    <form name="formlogin" method="post" action="register3.php" onSubmit="return(check());">
                        <table width="67%" border="0">
                            <tr>
                                <td colspan="2">
                                    <?php
                                    echo "<b><font color=#cc0033>亲爱的 " . $u . "，请继续填写您的资料。</font></b>";
                                    ?>
                                </td>
                            </tr>
                            <tr>
                                <td width="22%" align="right">密　码：</td>
                                <td width="78%">
                                    <input type="password" name="u_pass" class="think" maxlength="16" size="12">
                                    <font color="#CC0000">*</font>（4-16位数字或字母）
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td width="22%" align="right">您的Email：</td>
                                <td width="78%">
                            ...
                            <tr>
                                <td width="22%" align="right">性　别：</td>
                                <td width="78%">
                                    <select name="sex">
                            ...
                            <tr>
                                <td width="22%" align="right">所在省份：</td>
                                <td width="78%">
                            ...
                            <tr>
                                <td width="22%" align="right">所在城市：</td>
                                <td width="78%">
                            ...
                            <tr>
                                <td width="22%" align="right">证件号码：</td>
                                <td width="78%">
                            ...
                            <tr>
                                ...
                                <td width="78%">
                                    <input type="text" name="zzbh" class="think" maxlength="100">
                                </td>
                            </tr>
                            <tr>
                                <td width="22%" align="right">开户行：</td>
                                <td width="78%">
                                    <input type="text" name="khhh" class="think" maxlength="100">
                                </td>
                            </tr>
                            <tr>
                                <td width="22%" align="right">开户账户：</td>
                                <td width="78%">
                                    <input type="text" name="khzh" class="think" maxlength="100">
                                </td>
                            </tr>
                            <tr>
                                <td width="22%" align="right">备 注：</td>
                                <td width="78%">
                                    <textarea name="attrib" class="think" cols="40" rows="4"></textarea>
                                </td>
                            </tr>
                            <tr align="center">
                                <td colspan="2" height="43">
                                    <input type="hidden" name="u" value="<?php echo $u ?>">
                                    <input type="submit" name="Submit" value=" 注 册 " class=stbtm2>
                                    　　
                                    <input type="reset" name="Submit2" value=" 清 除 " class=stbtm2>
                                </td>
                            </tr>
                        </table>
                    </form>
