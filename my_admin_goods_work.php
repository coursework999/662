    ...
    if ($usage != 1) {
        ...
        <form name="form1" method="post" action="" onSubmit="return check();" enctype="multipart/form-data">
            <table width="80%" border="1" cellspacing="0" cellpadding="2" bgcolor="#E1EAF4" align="center"
                ...
                <tr>
                    <td width="16%" align="right">category£º</td>
                ...
                <tr>
                    <td width="16%" align="right">name£º</td>
                    <td width="84%">
                ...
                <tr>
                    <td width="16%" align="right">description£º</td>
                    <td width="84%">
                        <textarea name="descript" cols="60" rows="6"><?php echo $descript ?></textarea>
                        <font color="#FF0000">*</font></td>
                </tr>
                <tr>
                    <td width="16%" align="right">image£º</td>
                ...
                <tr>
                    <td width="16%" align="right">upload image£º</td>
                    <td width="84%">
                ...
                <tr>
                    <td width="16%" align="right">price£º</td>
                    <td width="84%">
                ...
                <tr>
                    <td width="16%" align="right">prime£º</td>
                    <td width="84%">
                ...
                <tr>
                    <td width="16%" align="right">status£º</td>
                    <td width="84%">
                ...
                <tr>
                    <td width="16%" align="right">time£º</td>
                    <td width="84%">
