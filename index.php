    ...
    <table width="98%" border="0" cellpadding="1" cellspacing="0">
        <tr>
            <td bgcolor="#ff6000" height="57">
                <table width=100% border=0 cellspacing=0 cellpadding=0>
                    <tr>
                        <td height=20 bgcolor=#ff6000 align=center><font color="#FFFFFF">友情链接</font></td>
                    </tr>
                    <tr>
                        <td height=2 bgcolor=#000000>
                            <spacer type=block width=1>
                    ...
                    <tr>
                        <td class=p7 bgcolor="#FFFFFF" align="right" height="24"><a href="links.php"><img
                                src="images/more.gif" width="50" height="10" border="0" alt="更多..."></a>&nbsp;&nbsp;
                        </td>
                    </tr>
                </table>
            </td>
...
<td width="170" valign="top" align="center">
    ...
    <table width=100% border=0 cellspacing=0 cellpadding=0>
        <tr>
            <td height=20 bgcolor=#2E5F49 align=center><font color="#FFFFFF">需求登记</font></td>
        </tr>
        <tr>
            <td height=1 bgcolor=#000000>
                <spacer type=block width=1>
            ...
            <td bgcolor="#750000">
                <table width=100% border=0 cellspacing=0 cellpadding=0>
                    <form name="form1" method="post" action="vote.php" target="vote">
                        <tr>
                            <td height=20 bgcolor=#750000 align=center><font color="#FFFFFF">本站调查
                                <?php
                        ...
                        <tr>
                            <td class=p7 bgcolor="#FFFFFF" style="line-height:150%" height="38" align="center">
                                <input type="submit" name="Submit" value="投 票" class="think"
                                       onClick="winopen('about:blank','vote')">
                                　
                                <input type="button" name="Submit2" value="结 果" class="think"
