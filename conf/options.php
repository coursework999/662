...
//admin_set_start 
    //网站管理员设置
$ad_name="zhubo";   //网站管理员用户名
$ad_pass="zhubo";   //网站管理员密码
$siteemail="buaazhubo@outlook.com";   //网站管理员的邮箱

//admin_set_end

//打开或者关闭商店 
$siteclose_flag = 0;
$sitereason = "本商城暂时关闭, 请稍后再回来.";
...
//网站联系方式，可以有多个，用空格分开
$siteadd = "成都市西安南路62号502";
$sitetel = "13568816551";
$siteemail = "webmaster@51shop.net";
